...
logformatter = ColoredFormatter(
    "\x1b[2;37m%(asctime)s \x1b[%(color1)sm%(levelname)-8s\x1b[m \x1b[4m%(name)s\x1b[m \x1b[%(color2)sm%(indentedmessage)s\x1b[m")
...
from .sip_bnf import URI
from .message import SIPMessage, SIPResponse, SIPRequest, REGISTER, INVITE, ACK, BYE, CANCEL, OPTIONS, INFO, PRACK, \
    UPDATE, NOTIFY
